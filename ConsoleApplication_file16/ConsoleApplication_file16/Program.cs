...
namespace ConsoleApplication_file16
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Color piexlColor = bmp.GetPixel(5, 5);
            //Console.WriteLine(piexlColor);
            //Color myred = Color.FromArgb(0xff, 0, 0);
            //bmp.SetPixel(5, 5, myred);
            //Color piexlColor1 = bmp.GetPixel(5, 5);
            //Console.WriteLine(piexlColor1);
            //Color piexlColor2 = bmp.GetPixel(5, 5);
            //string testname = "ffff0000";
            //if (piexlColor1.Name == testname)
            //{
